...
import { Card, PosterWrap, Poster, RatingBadge, HeartButton, Body, CardTitle, Year } from './components';
...
function MovieCard({ movie }: Props) {
  ...
  return (
    <Card to={`/movie/${movie.id}`} aria-label={title} onMouseEnter={prefetch} onFocus={prefetch}>
      <PosterWrap>
